...
InvHandler.addStartingItem("one", <item:minecraft:golden_carrot>, 2, (stack as crafttweaker.api.item.IItemStack, player as crafttweaker.api.entity.type.player.Player) as crafttweaker.api.item.IItemStack => {
      return stack * (64);
 });
