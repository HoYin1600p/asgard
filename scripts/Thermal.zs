...
craftingTable.addShaped("thermal_phyto_insolator", <item:thermal:machine_insolator>, [
    [<item:minecraft:air>, <item:woldsvaults:pog_prism>, <item:minecraft:air>],
...
craftingTable.addShaped("thermal_stabilized_coil", <item:thermal:rf_coil_storage_augment>, [
    ...
    [<item:woldsvaults:chromatic_gold_ingot>, <item:thermal:rf_coil>, <item:woldsvaults:chromatic_gold_ingot>],
    [<item:minecraft:air>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>]
]);

craftingTable.addShaped("thermal_side_config_augment", <item:thermal:side_config_augment>, [
    [<item:minecraft:air>, <tag:items:forge:nuggets/tin>, <item:minecraft:air>],
    [<tag:items:forge:nuggets/tin>, <item:woldsvaults:chromatic_gold_ingot>, <tag:items:forge:nuggets/tin>],
    [<item:minecraft:air>, <tag:items:forge:nuggets/tin>, <item:minecraft:air>]
]);

craftingTable.addShaped("thermal_rf_coil_augment", <item:thermal:rf_coil_augment>, [
    [<item:minecraft:air>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>],
    [<tag:items:forge:ingots/silver>, <item:thermal:rf_coil>, <tag:items:forge:ingots/silver>],
    [<item:minecraft:air>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>]
]);

craftingTable.addShaped("thermal_rf_coil_xfer_augment", <item:thermal:rf_coil_xfer_augment>, [
    [<item:minecraft:air>, <tag:items:forge:ingots/silver>, <item:minecraft:air>],
    [<tag:items:forge:ingots/silver>, <item:thermal:rf_coil>, <tag:items:forge:ingots/silver>],
    [<item:minecraft:air>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>]
]);
