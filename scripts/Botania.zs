...
craftingTable.addShaped("botania_spark", <item:botania:spark>, [
    ...
    [<item:quark:blaze_lantern>, <item:woldsvaults:chromatic_gold_block>, <item:quark:blaze_lantern>],
    [<item:the_vault:gem_larimar>, <tag:items:botania:petals>, <item:the_vault:gem_larimar>]
]);
...
craftingTable.addShaped("botania_hourglass", <item:botania:hourglass>, [
    [<item:woldsvaults:chromatic_gold_ingot>, <item:botania:mana_glass>, <item:woldsvaults:chromatic_gold_ingot>],
    [<item:minecraft:redstone>, <item:botania:manasteel_ingot>, <item:minecraft:redstone>],
    [<item:woldsvaults:chromatic_gold_ingot>, <item:botania:mana_glass>, <item:woldsvaults:chromatic_gold_ingot>]
]);

craftingTable.addShaped("botania_mana_pylon", <item:botania:mana_pylon>, [
    [<item:minecraft:air>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>],
    [<item:botania:manasteel_ingot>, <item:botania:mana_diamond>, <item:botania:manasteel_ingot>],
    [<item:minecraft:air>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>]
]);

craftingTable.addShaped("botania_lens_magnet", <item:botania:lens_magnet>, [
    [<item:botania:lens_normal>, <item:minecraft:iron_ingot>, <item:minecraft:air>],
    [<item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>]
]);

craftingTable.addShaped("jawns_terra_shatterer", <item:botania:terra_pick>, [
    [<item:woldsvaults:wold_star>, <item:woldsvaults:extraordinary_pog_prism>, <item:woldsvaults:wold_star>],
    [<item:mekanism:atomic_disassembler>, <item:botania:terrasteel_block>, <item:mekanism:atomic_disassembler>],
    [<item:woldsvaults:compressed_vault_essence_2>, <item:woldsvaults:crystal_reinforcement>, <item:woldsvaults:compressed_vault_essence_2>]
]);
