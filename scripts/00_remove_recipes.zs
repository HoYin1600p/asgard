...
craftingTable.remove(<item:ae2:memory_card>);
craftingTable.remove(<item:ae2:biometric_card>);
...
craftingTable.remove(<item:botania:lens_magnet>);
...
craftingTable.remove(<item:mekanismgenerators:electromagnetic_coil>);
...
craftingTable.remove(<item:darkutils:misfortune_plate>);
...
craftingTable.remove(<item:thermal:rf_coil_storage_augment>);
craftingTable.remove(<item:thermal:side_config_augment>);
craftingTable.remove(<item:thermal:rf_coil_augment>);
craftingTable.remove(<item:thermal:rf_coil_xfer_augment>);
...
JEI.hideIngredient(<item:ae2:creative_item_cell>);
JEI.hideIngredient(<item:ae2:creative_fluid_cell>);
