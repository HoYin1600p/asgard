...
craftingTable.addShaped("ae2_16k_component", <item:ae2:cell_component_16k>, [
    ...
    [<item:ae2:cell_component_4k>, <item:the_vault:extraordinary_larimar>, <item:ae2:cell_component_4k>],
...
craftingTable.addShaped("ae2_pattern_provider", <item:ae2:pattern_provider>, [
    [<item:woldsvaults:chromatic_gold_ingot>, <item:the_vault:vault_essence>, <item:woldsvaults:chromatic_gold_ingot>],
    [<item:ae2:formation_core>, <item:minecraft:crafting_table>, <item:ae2:annihilation_core>],
    [<item:woldsvaults:chromatic_gold_ingot>, <item:woldsvaults:pog_prism>, <item:woldsvaults:chromatic_gold_ingot>]
]);
