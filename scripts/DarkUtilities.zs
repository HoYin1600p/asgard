...
craftingTable.addShaped("darkutils_misfortune_plate", <item:darkutils:misfortune_plate>, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:phantom_membrane>, <item:woldsvaults:chromatic_gold_ingot>, <item:minecraft:phantom_membrane>],
    [<tag:items:darkutils:plate_base>, <tag:items:darkutils:plate_base>, <tag:items:darkutils:plate_base>]
]);
